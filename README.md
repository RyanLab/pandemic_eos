...
Instructions:
Download the CSV file, the R script file, and the R project file all in the same folder. Then, run the R script with the provided packages and libraries on your local computer.

Final Outcome:
The final dashboard interface should look like this
<img width="975" height="557" alt="image" src="https://github.com/user-attachments/assets/48d7329e-6e5e-4e73-9f52-51b9155efad6" />
